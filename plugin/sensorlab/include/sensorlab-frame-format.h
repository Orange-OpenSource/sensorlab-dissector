...
static const value_string event_names_dictionary[] = {
		...
		{	EVENT_NODE_PROPERTY_UPDATE   , 		"NodeUpdate"		},
		{	EVENT_NODE_REMOVE		     , 	    "NodeRemove"		},
		{	EVENT_ENTITY_ADD		     ,	    "EntityAdd"			},
		{	EVENT_ENTITY_PROPERTY_UPDATE ,      "EntityUpdate"		},
		{	EVENT_ENTITY_REMOVE		     ,		"EntityRemove"		},
		{	EVENT_LINK_ADD			     ,		"LinkAdd"			},
		{	EVENT_LINK_PROPERTY_UPDATE   ,		"LinkUpdate"		},
		{	EVENT_LINK_REMOVE		     ,		"LinkRemove"		},
		{	EVENT_FRAME_PRODUCE		     ,		"FrameProduce"		},
		{	EVENT_FRAME_PROPERTY_ADD	 ,		"FrameUpdate"		},
		{	EVENT_FRAME_PROPERTY_UPDATE	 ,		"FrameUpdate"		},
		{	EVENT_FRAME_DATA_UPDATE	     ,		"FrameUpdate"		},
